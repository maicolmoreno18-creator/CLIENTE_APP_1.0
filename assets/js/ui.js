...
// ── Tema claro / oscuro ───────────────────────────────────────────────────────
const Tema = (() => {
  const KEY = 'clienteapp_tema';

  function esOscuro() {
    return localStorage.getItem(KEY) === 'oscuro';
  }

  // Aplicar el tema guardado al <body> (llamar al iniciar la app)
  function aplicar() {
  ...
  function toggle() {
    ...
    localStorage.setItem(KEY, nuevo ? 'oscuro' : 'claro');
